<div>
    <div class="footer-area">
        <div class="container">
            <div class="row text-capitalize">
                <div class="col-md-3">
                    <h4 class="footer-heading">fit shop</h4>
                ...
                <div class="col-md-3">
                    ...
                    <div class="mb-2"><a href="{{route('home_page')}}" class="text-white">Trending Products</a></div>
                    <div class="mb-2"><a href="{{ route('new_arrivals')}}" class="text-white">New Arrivals Products</a></div>
                ...
                <div class="col-md-3">
                    ...
                    <div class="mb-2">
                        <a href="" class="text-white">
                            <i class="fa fa-envelope"></i> fitshopwebit@gmail.com
                        </a>
                    </div>
                </div>
            </div>
    ...
    <div class="copyright-area text-capitalize">
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    <p class=""> &copy; 2023 - fit shop IT ecommerce. all rights réserved.</p>
                </div>
                <div class="col-md-4">
